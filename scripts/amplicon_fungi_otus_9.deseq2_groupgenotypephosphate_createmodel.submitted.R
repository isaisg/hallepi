...
Root <- list(OTU = dds_otu_root,Genus = dds_genus_root,Family = dds_family_root,
             Order = dds_order_root,Class = dds_class_root,Phylum = dds_phylum_root)
Shoot <- list(OTU = dds_otu_shoot,Genus = dds_genus_shoot, Family = dds_family_shoot,
              Order = dds_order_shoot,Class = dds_class_shoot, Phylum = dds_phylum_shoot)



dds_res <- list(Root = Root, Shoot = Shoot)
saveRDS(object = dds_res,file = "../cleandata/dds_deseq2_hallepi_amplicon_fungi_otus_groupsgenotypephosphate.RDS")
