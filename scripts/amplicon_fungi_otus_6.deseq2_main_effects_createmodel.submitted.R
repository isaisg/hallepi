...
Dat_raw$Tax$ID %>% as.character  %>% 
  write(x = .,file = "../cleandata/718_otus.txt")
...
dds_res <- list(OTUs = dds_otus, Genus = dds_genus, Family = dds_family,
                Order = dds_order, Class = dds_class, Phylum = dds_phylum)
saveRDS(object = dds_res,file = "../cleandata/dds_deseq2_hallepi_amplicon_fungi_otus_maineffects.RDS")
