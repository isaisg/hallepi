...
# p <- ggplot(data = df_all,mapping = aes(Mode,Perc, fill = Order)) +
...
#   )
# oh.save.pdf(p = p, outdir = "../figures/",outname = "figure2_fungi_otus_phylogram_fraction_enrichments_depletions.pdf")
# 
