...
oh.save.pdf(p = composition,outname = "figure2_fungi_otus_alphadiversity.pdf",outdir = "../figures")
...
p <- chibi.boxplot(Map = Dat_sub$Map,facet_formula = "Fraction",x_val = "Genotype",
  ...
  geom_vline(xintercept = c(1.5,2.5),size = size_vline,
             color = color_vline) +
  theme(legend.position = "none")
oh.save.pdf(p = p,outname = "supfigure2_fungi_otus_alphadiversity_extended.pdf",outdir = "../figures")
