...
mpco <- oh.pco(Tab = Dat_sub$Tab %>% t,Map = Dat_sub$Map,ndim = 4,
               eig = T,distfun = distfun,id_var = "OTU_Header")
...
capture.output(file = "../figures/figure2_fungi_otus_samples_soilrootshoot_summary.doc",
...
oh.save.pdf(p = composition,outname = "figure2_fungi_otus_beta_diversity_maineffects_composition.pdf",outdir = "../figures/")
...
mycap$perm_anova_terms
capture.output(file = "../figures/figure3_fungi_otus_samples_root_summary.doc",
               append = F,print(mycap$perm_anova_terms))
...
p_perm <- p_perm + theme(legend.position = "none")
composition <- egg::ggarrange(p_perm,p, widths = c(0.05,1))
oh.save.pdf(p = composition,outname = "figure3_fungi_otus_beta_diversity_onlyroot_cap1_cap2_composition.pdf",outdir = "../figures/")
...
mycap$perm_anova_terms
capture.output(file = "../figures/figure3_fungi_otus_samples_soil_summary.doc",
               append = F,print(mycap$perm_anova_terms))
...
p_perm <- p_perm + theme(legend.position = "none")
composition <- egg::ggarrange(p_perm,p, widths = c(0.05,1))
oh.save.pdf(p = composition,outname = "figure3_fungi_otus_beta_diversity_onlysoil_cap1_cap2_composition.pdf",outdir = "../figures/")
...
mycap$perm_anova_terms
capture.output(file = "../figures/figure3_fungi_otus_samples_shoot_summary.doc",
               append = F,print(mycap$perm_anova_terms))
...
p_perm <- p_perm + theme(legend.position = "none")
composition <- egg::ggarrange(p_perm,p, widths = c(0.05,1))
oh.save.pdf(p = composition,outname = "figure3_fungi_otus_beta_diversity_onlyshoot_cap1_cap2_composition.pdf",
            outdir = "../figures/")
